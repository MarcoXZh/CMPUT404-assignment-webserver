...
class simpleWebServer(SocketServer.BaseRequestHandler):
...
pass # class simpleWebServer(SocketServer.BaseRequestHandler)
...
if __name__ == "__main__":
    ...
    server = SocketServer.TCPServer((HOST, PORT), simpleWebServer)
